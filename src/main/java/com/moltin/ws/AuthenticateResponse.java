...
public class AuthenticateResponse {
	...
	public boolean equals(final Object other) {
		...
		return new EqualsBuilder().append(tokenType, rhs.tokenType).append(expires, rhs.expires).append(accessToken, rhs.accessToken)
				.append(expiresIn, rhs.expiresIn).append(identifier, rhs.identifier).isEquals();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("expires", expires).append("identifier", identifier).append("expiresIn", expiresIn)
				.append("accessToken", accessToken).append("tokenType", tokenType).toString();
	}
