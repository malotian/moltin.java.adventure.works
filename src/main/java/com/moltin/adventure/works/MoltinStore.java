					...
					moltinProductVariationVariationOptions.getAsJsonObject("data").getAsJsonArray("options")
							.forEach(_moltinProductVariationVariationOption -> {
								...
								if (moltinProductVariationVariationOption.get("name").equals(csvProductModifierValue)) {
									...
									String productModifierSuffix = csvProductModifierValue.getAsString().replaceAll("/", "-").replaceAll(" ", "-");
									...
									final Modifier productModifierSkuAppend = new Modifier()
											.withData(new com.moltin.api.v2.modifiers.Data()
													.withType("product-modifier")
													.withModifierType("sku_append")
													.withValue("-" + productModifierSuffix));

									final Modifier productModifierSlugAppend = new Modifier()
											.withData(new com.moltin.api.v2.modifiers.Data()
													.withType("product-modifier")
													.withModifierType("slug_append")
													.withValue("-" + productModifierSuffix));

									final String moltinProductVariationVariationOptionUUID = moltinProductVariationVariationOption.get("id")
											.getAsString();

									final String moltinProductVariationVariationOptionProductModifierNameAppendUUID = new MoltinRequest(
											"variations", moltinProductVariationUUID, "variation-options",
											moltinProductVariationVariationOptionUUID, "product-modifiers").create(productModifierNameAppend)
													.get("data").getAsJsonObject().get("id").getAsString();

									final String moltinProductVariationVariationOptionProductModifierSkuAppendUUID = new MoltinRequest(
											"variations", moltinProductVariationUUID, "variation-options",
											moltinProductVariationVariationOptionUUID, "product-modifiers").create(productModifierSkuAppend)
													.get("data").getAsJsonObject().get("id").getAsString();

									final String moltinProductVariationVariationOptionProductModifierSlugAppendUUID = new MoltinRequest(
											"variations", moltinProductVariationUUID, "variation-options",
											moltinProductVariationVariationOptionUUID, "product-modifiers").create(productModifierSlugAppend)
													.get("data").getAsJsonObject().get("id").getAsString();

									relationshipProductVariation.getData().add(new Datum()
											.withType("product-variation")
